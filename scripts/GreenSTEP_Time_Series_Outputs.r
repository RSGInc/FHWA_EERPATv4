...
Time_Series <- list(AllState = AllState,
                    DVMThhCommVehbyCounty = DVMThhCommVehbyCounty,
                    DVMTbyDt = DVMTbyDt,
                    DVMTbyMode = DVMTbyMode,
                    CO2byMode = CO2byMode,
                    HhCO2byCounty = HhCO2byCounty,
                    HhCO2byDt = HhCO2byDt,
                    NumAutoLtTruckPowerTrain = NumAutoLtTruckPowerTrain,
                    FuelMode = FuelMode)

save(Time_Series, file = file.path(OutputDir, "Time_Series_.Rdata"))
